...
namespace A5Soft.DAL.Core.MicroOrm
{
    ...
    public sealed class FieldMapInt64<T> : ManagedOrmFieldMapBase<T, long> where T : class
    {
        ...
        public FieldMapInt64(string dbFieldName, string propName, Action<T, long> valueSetter,
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public FieldMapInt64(string propName, Action<T, long> valueSetter, bool isInitializable = false)
        ...
        {
            ValueSetter(instance, row.GetInt64(PropName));
        }

        internal override void SetValue(T instance, ILightDataReader reader)
        {
            ValueSetter(instance, reader.GetInt64(PropName));
        }
