...
namespace A5Soft.DAL.Core.MicroOrm
{
    ...
    public sealed class FieldMapInt16<T> : ManagedOrmFieldMapBase<T, short> where T : class
    {
        ...
        public FieldMapInt16(string dbFieldName, string propName, Action<T, short> valueSetter,
        ...
        /// <param name="isInitializable">a value indicating whether the property value should be set (initialized) 
        /// from the init query result</param>
        public FieldMapInt16(string propName, Action<T, short> valueSetter, bool isInitializable = false)
        ...
        {
            ValueSetter(instance, row.GetInt16(PropName));
        }

        internal override void SetValue(T instance, ILightDataReader reader)
        {
            ValueSetter(instance, reader.GetInt16(PropName));
        }
