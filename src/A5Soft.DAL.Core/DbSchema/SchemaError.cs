...
namespace A5Soft.DAL.Core.DbSchema
{
    ...
    public sealed class SchemaError
    {
        ...
        private readonly SchemaErrorType _errorType = SchemaErrorType.FieldMissing;
        ...
        internal SchemaError(SchemaErrorType errorType, string description, string table,
        ...
        internal SchemaError(SchemaErrorType errorType, string description, string table,
            ...
            : this(errorType, description, table, string.Empty, sqlStatementsToRepair) { }
        ...
        /// <exception cref="ArgumentNullException">SQL statements to repair the error is not specified.</exception>
        /// <exception cref="ArgumentException">No SQL statement could be empty.</exception>
        internal SchemaError(SchemaErrorType errorType, string description, string[] sqlStatementsToRepair)
        {
            if (description.IsNullOrWhiteSpace()) throw new ArgumentNullException(nameof(description));
            if (null == sqlStatementsToRepair || sqlStatementsToRepair.Length < 1)
                throw new ArgumentNullException(nameof(sqlStatementsToRepair));
        ...
        /// <param name="field">the name of the database field that is inconsistent</param>
        /// <exception cref="ArgumentNullException">Error description is not specified.</exception>
        internal SchemaError(SchemaErrorType errorType, string description, string table, string field)
        {
            if (description.IsNullOrWhiteSpace()) throw new ArgumentNullException(nameof(description));
        ...
        private void ValidateSqlStatements(string[] sqlStatements)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.DbSchemaError_EmptySqlStatementInList, 
                    nameof(sqlStatements));
            }
        }
